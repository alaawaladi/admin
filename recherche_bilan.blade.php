       ...
       <div class="col-12">
         <div class="card mb-4">
           <div class="card-header pb-0">
             <h1 style="font-size:30px">Opération de lutte contre l'émigration clandestine : bilan realisé par tranche horaire</h1>
           </div>
           <div class="card-body px-0 pt-0 pb-2">
             <div class="table-responsive p-0">
                <fieldset class="border p-2">
                    <legend  class="w-auto">    </legend><BR>
                       <form class="d-flex" action="{{route('bilan.tranche.horaire')}}" method="GET">
                         <table align="center" >
                           <TR >
                            <TD >
                        ...
                        <label>tranche horaire</label>
                             ...
                             <TD style="width: 500px;"><select id="tranche_horaire" name="tranche_horaire" class="form-control form-control-user" required>
                              <option >---Selectionner une tranche horaire---</option>
                              <option value="00h-10h">00h-10h</option>
                              <option value="10h-16h">10h-16h</option>
                              <option value="10h-16h">16h-00h</option></select>
                           </TD>
              ...
              <fieldset class="card" style="text-align: center;">
                  ...
                  <p style="font-family:Georgia;"><span style="color:#000000;">TRANCHE HORAIRE: </span> {{$tranche_horaire}} </p>
...
<a href="{{route('bilan.tranche.horaire.pdf')}}" class="btn btn-primary btn-block" > Telecharger le bilan format PDF</a></td>
