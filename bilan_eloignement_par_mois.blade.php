  ...
  <div class="table-responsive p-0">
    <div style="font-family:Georgia; color:#000099; font-size:30px ; margin-top:1em; margin-right:1em;"><B>1- Bilan des candidats eloignés par categorie: </B></div>
                     ...
                     <table class="table table-striped">
                      <tr> 
                        <td align="center" class="text-uppercase text-secondary text-xl font-weight-bolder opacity-10" rowspan="2" width="10px"> Date</td> 
                        <td align="center" class="text-uppercase text-secondary text-xl font-weight-bolder opacity-10" colspan="4" > TOTAL ELOIGNE DES CANDIDATS PAR CATEGORIE  </td> 
                      ...
                      @foreach ($period as $p)
                        ...
                        <tr>
                          ...
                          <td align="center" class="text-uppercase text-secondary text-xl font-weight-bolder opacity-10"> {{$d->nbre_sub}}</td>
                          <td align="center" class="text-uppercase text-secondary text-xl font-weight-bolder opacity-10">{{$d->nbre_mar}}</td>
                          <td align="center" class="text-uppercase text-secondary text-xl font-weight-bolder opacity-10">{{$d->nbre_autres}}</td>
                          <td align="center" class="text-uppercase text-secondary text-xl font-weight-bolder opacity-10"><?php $totale=$d->nbre_sub+$d->nbre_mar+$d->nbre_autres;echo($totale);?></td>
                        </tr>
                          @break
                            @endif
                        @endforeach
