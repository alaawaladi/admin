       ...
       <div class="col-12">
         <div class="card mb-4">
           <div class="card-header pb-0">
             <h1 style="font-size:30px">Bilan journalier des personnes interceptées pour l'immigration clandestine</h1>
           </div>
           <div class="card-body px-0 pt-0 pb-2">
             <div class="table-responsive p-0">
                <fieldset class="border p-2">
                    <legend  class="w-auto">    </legend><BR>
                       <form class="d-flex" action="{{route('bilan.jour')}}" method="GET">
                         <table align="center" >
                           <TR >
                            <TD >
                           ...
                           <tr>
                            ...
                            <input class="form-control form-control-user" type="date" name="date"></label>
                            </TD>
                            <TD >
                              <label>Date de fin</label>
                              </TD>
                            <TD style="width: 500px;">
                             <input class="form-control form-control-user" type="date" name="date_fin"></label>
                             </TD>
                       </tr>
                   <TR>
                     <TD colspan="6">
                   ...
                   <fieldset class="card" style="text-align: center">
                        ...
                        <?php if( (session('date')) &&  (session('date_fin')) ){?>
                        <p style="font-family:Georgia;"><span style="color:#000000;">PERIODE A PARTIR DE   : {{ session('date') }} JUSQU 'AU : {{ session('date_fin') }}</span></p>
                        
                        <?php } else{?>
                        <p style="font-family:Georgia;"><span style="color:#000000;">JOURNEE DU  : </span>{{$date}} </p>
                        <?php } ?>
                        
                        <p style="font-family:Georgia;"><span style="color:#000000;">VILLE\LOCALITE : </span>{{$ville}}</p>
                   </fieldset>
                   &#160;
                   &#160;
                   &#160;
                   ...
                   <div class="card">
                    ...
                    <table style="width:100%">
                      <tr>
                        ...
                        <table class="table table-striped">
                          <tbody>
                            <tr><td align="center" class="text-uppercase text-secondary text-xl font-weight-bolder opacity-10">ville</td><td align="center" class="text-uppercase text-secondary text-xl font-weight-bolder opacity-10">Total des personnes interceptées</td></tr>
                  ...
                  @endif
                  @endif
                  <a href="{{route('bilan.jour.pdf')}}" class="btn btn-primary btn-block" > Telecharger le bilan format PDF</a></td>
