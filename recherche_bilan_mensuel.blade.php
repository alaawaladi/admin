       ...
       <div class="col-12">
         <div class="card mb-4">
           <div class="card-header pb-0">
             <h1 style="font-size:30px">Opération de lutte contre l'émigration clandestine: bilan realisé par mois</h1>
           </div>
           <div class="card-body px-0 pt-0 pb-2">
             <div class="table-responsive p-0">
                <fieldset class="border p-2">
                    <legend  class="w-auto">    </legend><BR>
                       <form class="d-flex" action="{{route('bilan.mois')}}" method="GET">
                         <table align="center" >
                           <TR >
                            <TD >
                       ...
                       <TR>
                          ...
                          <TD >
                            ...
                            <TD style="width: 500px;">
                             <input class="form-control form-control-user" type="month" name="date"></label>
                            </TD>
                   </TR>
                   <TR>
                     <TD colspan="6">
                   ...
                   <fieldset class="card" style="text-align: center">
                        ...
                        <p style="font-family:Georgia;"><span style="color:#000000;">Mois : </span>{{$date}} </p>
                  ...
                  <a href="{{route('bilan.mois.pdf')}}" class="btn btn-primary btn-block" > Telecharger le bilan format PDF</a></td>
